...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final float DEFAULT_FADING_EDGE_STRENGTH = 2f;
     ...
     */
    private static final float DEFAULT_LINE_SPACING_MULTIPLIER = 5f;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOrientation = attributes.getInt(R.styleable.NumberPicker_np_orientation, HORIZONTAL);
